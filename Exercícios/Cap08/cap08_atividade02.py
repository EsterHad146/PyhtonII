...
print("dicCAtegoria['3']: ", dicCategoria['3'])
# imprimir a descrição da conteúdo da chave 3 do dicionário
print("dicCategoria['3'][0]", dicCategoria['3'][0])
print("dicCategoria['3'][1]", dicCategoria['3'][1])

print('------------------')
print("dicCategoria['5'][0]", dicCategoria['5'][0])
print("dicCategoria['5'][1]", dicCategoria['5'][1])