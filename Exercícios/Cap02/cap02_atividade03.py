"""
  Cap02 - Atividade 03
  Objetivo conhecer funções para manipulação de strings 
"""
...
print('4. Primeira letra em maiusculo:', nomeCompleto.title())
...
print('5. Somente o primeiro nome:', nomeCompleto[0:espaco].capitalize())
